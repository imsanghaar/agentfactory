...
- **Repository URL**: `https://github.com/imsanghaar/fastapi-agent-helm.git` (public example repo)
- **Revision**: `HEAD`
...
argocd app create fastapi-agent-cli \
  --repo https://github.com/imsanghaar/fastapi-agent-helm.git \
  --path charts/fastapi-agent \
...
spec:
  ...
  source:
    repoURL: https://github.com/imsanghaar/fastapi-agent-helm.git
    path: charts/fastapi-agent
    targetRevision: HEAD
    helm:
      values: |
...
Spec:
  ...
  Source:
    Path:               charts/fastapi-agent
    Repo Url:           https://github.com/imsanghaar/fastapi-agent-helm.git
...
helm template fastapi-agent \
  https://github.com/imsanghaar/fastapi-agent-helm.git/charts/fastapi-agent \
  --values values.yaml
```
