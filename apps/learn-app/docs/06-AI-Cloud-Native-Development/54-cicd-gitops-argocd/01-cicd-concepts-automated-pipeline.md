...
**Example trigger context**: Your FastAPI agent lives in `imsanghaar-agents/agent-task-service` on GitHub. When you push to `main`, GitHub Actions receives a webhook event. The pipeline is triggered.
