---
sidebar_position: 12
title: "Chapter 13: Master Spec-Kit Plus Quiz"
chapter: 13
lesson: 12
duration_minutes: 20
...
# Chapter 13: Master Spec-Kit Plus Quiz

Test your mastery of Spec-Kit Plus workflow. This assessment covers command recognition, artifact matching, and workflow sequencing through your research paper project.
...
{
question: "After completing a research paper project, you want to create a reusable 'academic-research' skill from your experience. Which phase's outputs most inform the skill's design?",
options: [
"Specification phase — the spec defines what the skill should produce",
"Planning phase — research approach informs the skill's reasoning patterns",
"Tasks phase — task descriptions become the skill's step-by-step workflow",
"Implementation phase — execution experience reveals which patterns to encode"
],
correctOption: 3,
explanation: "Implementation experience reveals which patterns are worth encoding as reusable skills. During execution, you discover what worked (synthesis strategies, source evaluation heuristics, writing patterns) and what didn't. These real insights—not theoretical plans—become the skill's core reasoning framework. The spec defines WHAT, not HOW to think. Planning provides initial approach but implementation refines it. Tasks describe work units, not reasoning patterns. Skills emerge from doing, then reflecting on what made execution effective.",
...
source: "Chapter 13: Foundation and Integration"
},
{
...
"Skip the skill and follow the original workflow from Chapter 13 exactly",
"Use it if you understand the persona, reasoning patterns, and constraints driving it"
],
correctOption: 3,
explanation: "Skills are reusable decision frameworks, not rigid templates. Your colleague should use the skill if they understand the underlying persona (what reasoning mode it activates), the reasoning patterns (what decisions it guides), and the constraints (what principles it enforces). This understanding enables adaptation to their specific project. Option 2 is close but emphasizes adaptation separately from skill use. Direct reuse without understanding (option 1) violates the intelligence reuse principle. Skipping reusable intelligence wastes accumulated knowledge.",
source: "Lesson 9: Designing Reusable Intelligence"
},
{
...
source: "Chapter 13: Integration and Learning Outcomes"
}
]}
