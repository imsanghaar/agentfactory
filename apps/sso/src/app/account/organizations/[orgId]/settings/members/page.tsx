...
import { member, organization, user, invitation } from "../../../../../../../auth-schema";
...
export default async function MembersPage({
  ...
  const isOwnerOrAdmin = ["owner", "admin", "manager"].includes(membership.role);
  ...
  // Get pending invitations (only for owners/admins/managers)
  ...
  return (
    <div className="space-y-6">
      {/* Pending Invitations (Owner/Admin/Manager only) */}
