...
export default async function OrganizationsPage() {
  ...
  // Check if user is admin (for showing create button)
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-8">
          <div className="relative">
            {/* Decorative accent */}
            <div className="absolute -left-3 top-0 bottom-0 w-1 bg-gradient-to-b from-primary to-primary/80 rounded-full" />
            ...
            <div className="max-w-md mx-auto">
              ...
              <p className="text-muted-foreground mb-6">
                {isAdmin
                  ...
                  : "You're not a member of any organization yet. Contact an admin to get invited."}
              </p>
              {isAdmin && <CreateOrgDialog />}
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {userOrgs.map((org: typeof userOrgs[number]) => (
              <OrganizationCard
                ...
                userRole={org.userRole as "owner" | "admin" | "manager" | "proctor" | "editor" | "member"}
