...
> **Spec-Driven Blueprint for Building and Monetizing Digital FTEs**
>
...
<p align="center">
  <img src="book_logo_imsanghaar.png" alt="The AI Agent Factory - The Spec-Driven Blueprint for Building and Monetizing Digital FTEs" width="600" />
</p>
...
Experience video learning like never before with our custom-built projector animation system. When you click the Play button on the Preface page, witness a realistic projector descend from the ceiling, cast animated light rays, and project the video onto a floating screen with a black background for a theater-like experience.

**Features:**
- 🎬 **Realistic Projector Animation** - Projector descends from top with detailed lens and vents
- ✨ **Animated Light Rays** - 5 light beams with blur and glow effects
- 📽️ **Floating Projection Screen** - Screen with glowing blue border effect
- 🎭 **Cinematic Black Background** - Full-screen black overlay for immersive viewing
- 📱 **Fully Responsive** - Desktop (900px), Tablet, and Mobile (95% width) optimized
- ⚡ **60fps Performance** - GPU-accelerated animations with smooth transitions
- ♿ **Accessible** - Keyboard navigation, screen reader support, focus trap
- 🎯 **YouTube Iframe Integration** - Direct embed for reliable playback across all devices

**Technical Stack:**
- Radix UI Dialog for modal foundation
- Custom CSS animations with cubic-bezier easing
- YouTube iframe API for video playback
- Event-driven architecture for global triggers
- Responsive design with 16:9 aspect ratio maintenance

**Mobile Optimizations:**
- Smaller projector (120px × 50px on mobile vs 180px × 80px desktop)
- Adjusted light ray coverage for smaller screens
- 95% width screen container for optimal mobile viewing
- Touch-friendly close button (35px × 35px)
- Maintained 16:9 video aspect ratio on all devices

**Learn More:** [`apps/learn-app/src/components/ChapterVideoModal/`](apps/learn-app/src/components/ChapterVideoModal/)
