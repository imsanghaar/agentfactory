...
- [ ] T001 Create chapter directory structure at `/apps/learn-app/docs/05-Spec-Kit-Plus-Methodology/31-spec-kit-plus-hands-on/` with subdirectories: `examples/`, `exercises/`, `ai-prompts/`
...
- [ ] T003 [P] Create Chapter README at `/apps/learn-app/docs/05-Spec-Kit-Plus-Methodology/31-spec-kit-plus-hands-on/README.md` with: chapter overview, learning journey (8 lessons), prerequisites (Chapter 30 completion), calculator project introduction, Part 5 context (Chapters 30-32), links to all 8 lessons

- [ ] T004 [P] Create lesson template at `/apps/learn-app/docs/05-Spec-Kit-Plus-Methodology/31-spec-kit-plus-hands-on/_lesson-template.md` with standard sections: title, duration, proficiency target (CEFR + Bloom's), learning objectives, skills taught, key concepts, content outline, key insights, code examples, "Try With AI" (final section)
...
- [ ] T006 [P] Create spec template reference at `/apps/learn-app/docs/05-Spec-Kit-Plus-Methodology/31-spec-kit-plus-hands-on/spec-template-reference.md` showing example of each section with annotations explaining purpose

- [ ] T007 [P] Create validation checklist template at `/apps/learn-app/docs/05-Spec-Kit-Plus-Methodology/31-spec-kit-plus-hands-on/validation-checklist-template.md` showing how to map acceptance criteria to testable conditions (pass/fail)
...
- [ ] T009 [US1] Write Lesson 1 content at `/apps/learn-app/docs/05-Spec-Kit-Plus-Methodology/31-spec-kit-plus-hands-on/01-installation-and-setup.md`
...
- [ ] T010 [P] [US1] Create Lesson 1 code examples at `/apps/learn-app/docs/05-Spec-Kit-Plus-Methodology/31-spec-kit-plus-hands-on/examples/lesson-1-installation/`
...
- [ ] T011 [P] [US1] Create Lesson 1 exercises at `/apps/learn-app/docs/05-Spec-Kit-Plus-Methodology/31-spec-kit-plus-hands-on/exercises/lesson-1-exercises.md`
...
- [ ] T013 [P] [US1] Create "Try With AI" prompts for Lesson 1 at `/apps/learn-app/docs/05-Spec-Kit-Plus-Methodology/31-spec-kit-plus-hands-on/ai-prompts/lesson-1-try-with-ai.md`
...
- [ ] T015 [US2] Write Lesson 2 content at `/apps/learn-app/docs/05-Spec-Kit-Plus-Methodology/31-spec-kit-plus-hands-on/02-constitution-phase.md`
...
- [ ] T016 [US2] Write Lesson 3 content at `/apps/learn-app/docs/05-Spec-Kit-Plus-Methodology/31-spec-kit-plus-hands-on/03-specify-phase.md`
...
- [ ] T017 [P] [US2] Create Lesson 2 code examples at `/apps/learn-app/docs/05-Spec-Kit-Plus-Methodology/31-spec-kit-plus-hands-on/examples/lesson-2-constitution/`
...
- [ ] T018 [P] [US2] Create Lesson 3 code examples at `/apps/learn-app/docs/05-Spec-Kit-Plus-Methodology/31-spec-kit-plus-hands-on/examples/lesson-3-specification/`
...
- [ ] T019 [P] [US2] Create Lessons 2-3 exercises at `/apps/learn-app/docs/05-Spec-Kit-Plus-Methodology/31-spec-kit-plus-hands-on/exercises/lesson-2-3-exercises.md`
...
- [ ] T021 [P] [US2] Create "Try With AI" prompts for Lessons 2-3 at `/apps/learn-app/docs/05-Spec-Kit-Plus-Methodology/31-spec-kit-plus-hands-on/ai-prompts/lesson-2-3-try-with-ai.md`
...
- [ ] T022 [P] [US2] Create Constitution template reference at `/apps/learn-app/docs/05-Spec-Kit-Plus-Methodology/31-spec-kit-plus-hands-on/constitution-template-reference.md` showing example Constitution structure with annotations
...
- [ ] T023 [US3] Write Lesson 4 content at `/apps/learn-app/docs/05-Spec-Kit-Plus-Methodology/31-spec-kit-plus-hands-on/04-clarify-phase.md`
...
- [ ] T024 [US3] Write Lesson 5 content at `/apps/learn-app/docs/05-Spec-Kit-Plus-Methodology/31-spec-kit-plus-hands-on/05-plan-phase.md`
...
- [ ] T025 [US3] Write Lesson 6 content at `/apps/learn-app/docs/05-Spec-Kit-Plus-Methodology/31-spec-kit-plus-hands-on/06-tasks-phase.md`
...
- [ ] T026 [P] [US3] Create Lesson 4 code examples at `/apps/learn-app/docs/05-Spec-Kit-Plus-Methodology/31-spec-kit-plus-hands-on/examples/lesson-4-clarify/`
...
- [ ] T027 [P] [US3] Create Lesson 5 code examples at `/apps/learn-app/docs/05-Spec-Kit-Plus-Methodology/31-spec-kit-plus-hands-on/examples/lesson-5-plan/`
...
- [ ] T028 [P] [US3] Create Lesson 6 code examples at `/apps/learn-app/docs/05-Spec-Kit-Plus-Methodology/31-spec-kit-plus-hands-on/examples/lesson-6-tasks/`
...
- [ ] T029 [P] [US3] Create Lessons 4-6 exercises at `/apps/learn-app/docs/05-Spec-Kit-Plus-Methodology/31-spec-kit-plus-hands-on/exercises/lesson-4-6-exercises.md`
...
- [ ] T031 [P] [US3] Create "Try With AI" prompts for Lessons 4-6 at `/apps/learn-app/docs/05-Spec-Kit-Plus-Methodology/31-spec-kit-plus-hands-on/ai-prompts/lesson-4-6-try-with-ai.md`
...
- [ ] T032 [P] [US3] Create checkpoint pattern reference at `/apps/learn-app/docs/05-Spec-Kit-Plus-Methodology/31-spec-kit-plus-hands-on/checkpoint-pattern-reference.md` showing:
...
- [ ] T033 [P] [US3] Create task lineage reference at `/apps/learn-app/docs/05-Spec-Kit-Plus-Methodology/31-spec-kit-plus-hands-on/task-lineage-reference.md` showing calculator example:
...
- [ ] T035 [US4] Write Lesson 7 content at `/apps/learn-app/docs/05-Spec-Kit-Plus-Methodology/31-spec-kit-plus-hands-on/07-implement-phase.md`
...
- [ ] T036 [P] [US4] Create Lesson 7 code examples at `/apps/learn-app/docs/05-Spec-Kit-Plus-Methodology/31-spec-kit-plus-hands-on/examples/lesson-7-implement/`
...
- [ ] T037 [P] [US4] Create Lesson 7 exercises at `/apps/learn-app/docs/05-Spec-Kit-Plus-Methodology/31-spec-kit-plus-hands-on/exercises/lesson-7-exercises.md`
...
- [ ] T039 [P] [US4] Create "Try With AI" prompts for Lesson 7 at `/apps/learn-app/docs/05-Spec-Kit-Plus-Methodology/31-spec-kit-plus-hands-on/ai-prompts/lesson-7-try-with-ai.md`
...
- [ ] T040 [P] [US4] Create validation mastery guide at `/apps/learn-app/docs/05-Spec-Kit-Plus-Methodology/31-spec-kit-plus-hands-on/validation-mastery-guide.md` showing:
...
- [ ] T041 Write Lesson 8 content at `/apps/learn-app/docs/05-Spec-Kit-Plus-Methodology/31-spec-kit-plus-hands-on/08-capstone-integration.md`
...
- [ ] T042 [P] Create Lesson 8 exercises at `/apps/learn-app/docs/05-Spec-Kit-Plus-Methodology/31-spec-kit-plus-hands-on/exercises/lesson-8-exercises.md`
...
- `/apps/learn-app/docs/05-Spec-Kit-Plus-Methodology/31-spec-kit-plus-hands-on/01-installation-and-setup.md`
- `/apps/learn-app/docs/05-Spec-Kit-Plus-Methodology/31-spec-kit-plus-hands-on/02-constitution-phase.md`
- `/apps/learn-app/docs/05-Spec-Kit-Plus-Methodology/31-spec-kit-plus-hands-on/03-specify-phase.md`
- `/apps/learn-app/docs/05-Spec-Kit-Plus-Methodology/31-spec-kit-plus-hands-on/04-clarify-phase.md`
- `/apps/learn-app/docs/05-Spec-Kit-Plus-Methodology/31-spec-kit-plus-hands-on/05-plan-phase.md`
- `/apps/learn-app/docs/05-Spec-Kit-Plus-Methodology/31-spec-kit-plus-hands-on/06-tasks-phase.md`
- `/apps/learn-app/docs/05-Spec-Kit-Plus-Methodology/31-spec-kit-plus-hands-on/07-implement-phase.md`
- `/apps/learn-app/docs/05-Spec-Kit-Plus-Methodology/31-spec-kit-plus-hands-on/08-capstone-integration.md`
