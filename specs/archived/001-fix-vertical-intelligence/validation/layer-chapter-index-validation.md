...
```bash
$ ls -la apps/learn-app/docs/02-AI-Tool-Landscape/06-gemini-cli-installation-and-basics/
total 152
...
```bash
$ ls apps/learn-app/docs/03-prompt-and-context-engineering/09-prompt-engineering-for-aidd/
README.md
...
```bash
$ ls apps/learn-app/docs/05-Spec-Kit-Plus-Methodology/30-specification-driven-development-fundamentals/
