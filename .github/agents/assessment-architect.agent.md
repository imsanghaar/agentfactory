...
argument-hint: A learning objective, lesson plan, or assessment to design or validate
tools: ['vscode', 'execute', 'read', 'agent', 'edit', 'search', 'web', 'context7/*', 'todo']

---
#  Skills Activation
Use quiz-generator, skills-proficiency-mapper, learning-objectives, code-example-generator all these skills on demand when needed
