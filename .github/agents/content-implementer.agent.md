...
# Skills Activation
Use ai-collaborate-teaching, learning-objectives, content-evaluation-framework, concept-scaffolding, skills-proficiency-mapper, code-example-generator, technical-clarity, canonical-format-checker all these skills on demand when needed.
